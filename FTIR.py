...
#        self.setCentralWidget(self.tabwidget)
        ...
        saveDataTxt = create_action(self, _("Save Text"), shortcut="Ctrl+T",
                                    icon=get_std_icon("DialogSaveButton"),
                                    tip=_("Save data as ASCII text"),
                                    triggered=self.saveDataTxt)
        saveDataHDF5 = create_action(self, _("Save HDF5"), shortcut="Ctrl+S",
                                    icon=get_std_icon("DialogSaveButton"),
                                    tip=_("Save data in HDF5"),

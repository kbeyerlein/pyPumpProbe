...
class PiStageUi(QSplitter):
    ...
    def __init__(self, parent):
        ...
        self.deltaMovePlus_fs.released.connect(
            lambda x=1: self.moveRel_fs(float(self.deltaMove_fs.text())))
        self.deltaMoveMinus_fs.released.connect(
            lambda x=-1: self.moveRel_fs(float(self.deltaMove_fs.text()), x))
    ...
    def connectStage(self):
        gcs = GCSDevice(gcsdll="C:/Software/PI C863/PI_GCS2_DLL/PI_GCS2_DLL_x64.dll")
        try:
